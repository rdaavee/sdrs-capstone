            ...
            <div className="bg-gray-100">
                ...
                >
                    ...
                    <p>
                        ...
                        Diploma, or Good Moral or Honorable Dismissal" our team
                        is here to help. All you have to do is register and
                        submit your request by creating a “new support ticket
                        and specify your request”. You can even keep track of
                        the “‘status of your ticket, so you know exactly when
                        your request has been completed.
                    </p>
                    <button
                        className="entry-button mt-5"
                        onClick={handleVisitHelpdesk}
                    >
                ...
                <section className="guide2-container py-16">
                    <div className="guide2-content">
                        ...
                        />
                        <h4>
                            2. Log in to your PHINMA UPang account to access
                            your dashboard.
                        </h4>
                    </div>
                </section>
                ...
                <section className="guide1-container py-16">
                    <div className="guide1-content">
                        ...
                        />
                        <h4>
                            3. Create a new support ticket and specify your
                            request.
                        </h4>
                    </div>
                </section>
